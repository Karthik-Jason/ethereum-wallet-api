...
function contractInfo(network) {
  ...
  return _ref = {}, (0, _defineProperty2["default"])(_ref, _tokens["default"].DAI, [{
    version: 1,
    ...
    abi: abis.general.erc20,
    decimals: 18
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_TOP, [{
    version: 1,
    address: addresses.TOP,
    abi: abis.daiV1.saiTop
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_PIP, [{
    version: 1,
    address: addresses.PIP,
    abi: abis.dappHub.dsValue
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_PEP, [{
    version: 1,
    address: addresses.PEP,
    abi: abis.dappHub.dsValue
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_PIT, [{
    version: 1,
    address: addresses.PIT,
    abi: abis.daiV1.pit
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_SIN, [{
    version: 1,
    address: addresses.SIN,
    abi: abis.general.erc20
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_DAD, [{
    version: 1,
    address: addresses.DAD,
    abi: abis.dappHub.dsGuard
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_MOM, [{
    version: 1,
    address: addresses.MOM,
    abi: abis.daiV1.mom
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_VOX, [{
    version: 1,
    address: addresses.VOX,
    abi: abis.daiV1.vox
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_TAP, [{
    version: 1,
    address: addresses.TAP,
    abi: abis.daiV1.tap
  }]), (0, _defineProperty2["default"])(_ref, _contracts["default"].SAI_TUB, [{
    version: 1,
    address: addresses.TUB,
    abi: abis.daiV1.tub
