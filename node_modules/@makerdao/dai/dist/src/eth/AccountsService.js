...
function (_PublicService) {
  ...
  function AccountsService() {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(AccountsService).call(this, name, ['log', 'event']));
    _this._accounts = {};
  ...
  (0, _createClass2["default"])(AccountsService, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                this.get('log').info("Not adding account \"".concat(name, "\" (no address found)"));
              ...
              case 17:
                ...
                account = (0, _objectSpread2["default"])({
                  name: name,
                  type: type,
    ...
    value: function useAccount(name) {
      ...
      if (account.type === _constants.AccountType.BROWSER) {
        ...
        if (window.web3.eth.defaultAccount && window.web3.eth.defaultAccount.toLowerCase() !== account.address) {
          throw new Error('cannot use a browser account that is not currently selected');
          ...
          return _regenerator["default"].wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  activeBrowserAddress = window.web3.eth.defaultAccount.toLowerCase();
