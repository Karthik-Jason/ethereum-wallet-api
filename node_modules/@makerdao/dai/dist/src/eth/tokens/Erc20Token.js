...
function () {
  ...
  (0, _createClass2["default"])(Erc20Token, [{
    key: "allowance",
    value: function () {
      var _allowance = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(tokenOwner, spender) {
    ...
    key: "balanceOf",
    value: function () {
      var _balanceOf = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(owner) {
    ...
    key: "totalSupply",
    value: function () {
      var _totalSupply = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function approve(spender, value) {
      ...
      return this._contract.approve(spender, this._valueForContract(value, unit), (0, _objectSpread2["default"])({
        metadata: {
          action: {
            name: 'approve',
            spender: spender,
    ...
    value: function approveUnlimited(spender) {
      ...
      return this._contract.approve(spender, -1, (0, _objectSpread2["default"])({
        metadata: {
          action: {
            name: 'approve',
            spender: spender,
